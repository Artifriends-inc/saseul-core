...
class ScriptFinder
{
    ...
    {
        return self::GetInterfaces(ROOT_DIR . '/Saseul/Custom/Status', $opt);
    }
    ...
    {
        return self::GetInterfaces(ROOT_DIR . '/Saseul/Custom/Transaction', $opt);
    }
    ...
    {
        return self::GetInterfaces(ROOT_DIR . '/Saseul/Custom/Request', $opt);
    }
