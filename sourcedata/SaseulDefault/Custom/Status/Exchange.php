...
class Exchange extends Status
{
    ...
    public static function _Load()
    {
        ...
        foreach (self::$exchange_keys as $item) {
            ...
            foreach ($rs as $order) {
                $order = Parser::objectToArray($order);
                $eid = $order['eid'];
                unset($order['_id']);
    ...
    public static function _Postprocess()
    {
        ...
        $coin = \Saseul\Custom\Method\Coin::GetAll($addresses);
        $token = \Saseul\Custom\Method\Token::GetAll($addresses, $token_names);
        ...
        \Saseul\Custom\Method\Coin::SetAll($coin);
        \Saseul\Custom\Method\Token::SetAll($token);
